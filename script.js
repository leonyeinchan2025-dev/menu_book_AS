            ...
            let htmlContent = `
                <div class="my-page cover">
                    <div class="page-content">
                        <img src="images/NHY.jpg" alt="Logo" class="logo-image">
                        <h1>AI GURU MENU</h1>
                        <p class="myanmar-text">ဒီဂျစ်တယ် အပြန်အလှန်ဆက်သွယ်နိုင်သော ကတ်တလောက်</p>
                ...
                <div class="my-page cover">
                    <div class="page-content">
                        ...
                        <div class="contact-links">
                            <a href="https://t.me/+959123456789" target="_blank" class="btn-link myanmar-text telegram-btn">Telegram သို့ ဆက်သွယ်ရန်</a>
